/*SQL script creates an auxillary calendar table for use in Microsoft T-SQL; uses binary-multiplication within the auxIntegers.sql file*/

SELECT *
FROM (
  SELECT i0.i + i1.i + i2.i + i3.i + i4.i + i5.i + i6.i + i7.i + i8.i + i9.i + i10.i AS i
  ...
  CROSS JOIN (SELECT 0 AS i UNION SELECT POWER(2,10)) AS i10) AS i
